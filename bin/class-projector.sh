...
if [ "x$1" = "xon" ] ; then
	...
	#nvidia-settings --assign CurrentMetaMode="DFP-2: 1440x900 { ViewPortIn=800x600, ViewPortOut=800x600+0+0 }, DFP-1: 800x600 { ViewPortIn=800x600, ViewPortOut=800x600+0+0 }"
else 
